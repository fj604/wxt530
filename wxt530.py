...
argparser.add_argument("-m", "--mqtt", default="localhost",
...
t['A'] = {0: "Wind direction min",
          1: "Wind direction average", 2: "Wind direction max"}
t['S'] = {0: "Wind speed min", 1: "Wind speed average", 2: "Wind speed max"}
t['P'] = {0: "Pressure"}
t['C'] = {0: "Air temperature", 1: "Internal temperature",
          2: "Heating temperature", 3: "Aux. temperature (pt1000)"}
t['H'] = {0: "Relative humidity"}
t['V'] = {0: "Rain accumulation", 1: "Hail accumulation"}
t['Z'] = {0: "Rain duration", 1: "Hail duration"}
t['R'] = {0: "Rain current intensity", 1: "Hail current intensity",
          2: "Rain peak intensity", 3: "Hail peak intensity"}
t['U'] = {0: "Supply voltage", 1: "Heating voltage", 2: "3.5 V reference voltage",
          3: "Solar radiation", 4: "Ultrasonic level sensor"}
    ...
    while True:
        ...
        if items[0] == header:
            ...
            while i < len(items):
                ...
                t_id = int(items[i + 3])
                m.append(
                    {"measurement": t[t_type][t_id], "data": data, "units": u[t_type][units]})
                if not args.json:
